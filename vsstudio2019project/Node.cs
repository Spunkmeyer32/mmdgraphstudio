...
namespace MMDGraphStudio
{
  ...
  class Node
  {
    ...
    public void addNodeProperty(NodePropertyValue propertyValue)
    {
      this.nodePropertyValues.Add(propertyValue);
    }
    ...
    internal NodePropertyValue getProperty(string v)
    {
      foreach(NodePropertyValue propertyValue in this.nodePropertyValues)
      {
        if(propertyValue.getName().Equals(v))
        {
