namespace MMD_Graph_Studio
{
  partial class ChangeNodePropertyForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.button_propertyvalueSave = new System.Windows.Forms.Button();
      ...
      this.button_propertyedit.Text = "Edit propertytype";
      ...
      this.button_useproperty.Text = "Use propertytype";
      this.button_useproperty.UseVisualStyleBackColor = false;
      // 
      // button_propertyvalueSave
      // 
      ...
      this.button_propertyvalueSave.TabIndex = 16;
      this.button_propertyvalueSave.Text = "Save Value";
      this.button_propertyvalueSave.UseVisualStyleBackColor = false;
      // 
      ...
      this.button_propertydelete.Text = "Delete propertytype";
      ...
      this.button_propertyremove.Text = "Do not use propertytype";
      ...
      this.Controls.Add(this.button_propertyvalueSave);
      ...
      this.PerformLayout();
        ...
        private System.Windows.Forms.Button button_propertyvalueSave;
